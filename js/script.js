...
function myfunction() {
    ...
    // for paragraph
    let waqiya_paragraph = document.querySelectorAll(".waqiya_pg p")
...
let waqiya_pg = document.querySelector(".waqiya_pg")
...
function remove_input_and_p() {
    ...
    let p = document.querySelector(".waqiya_pg p:last-child")
    input.remove()
    p.remove()
}